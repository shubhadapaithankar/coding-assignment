        ...
        <Paper elevation={6} style={{ margin: "10px", padding: "15px", textAlign: "left" }} key={vaccinationRecord.id}>
          ...
          <TableContainer component={Paper}>
            <Table className={classes2.table} aria-label="simple table">
              <TableBody>
                <TableRow>
                  <TableCell component="th" scope="row">Government Id:</TableCell>
                ...
                <TableRow>
                  <TableCell component="th" scope="row">Date of First Dose:</TableCell>
                  <TableCell align="left">{vaccinationRecord.dateOfFirstDose}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell component="th" scope="row">Date of Second Dose:</TableCell>
                  <TableCell align="left">{vaccinationRecord.dateOfSecondDose}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell component="th" scope="row">Date of First Booster Shot:</TableCell>
                  <TableCell align="left">{vaccinationRecord.dateOfFirstBooster}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell component="th" scope="row">Type of Vaccine:</TableCell>
